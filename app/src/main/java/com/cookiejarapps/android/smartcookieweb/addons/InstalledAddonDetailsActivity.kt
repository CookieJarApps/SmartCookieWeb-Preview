            ...
            if (isChecked) {
                this.components.addonManager.enableAddon(
                        ...
                        onSuccess = {
                            ...
                            Toast.makeText(
                                    this,
                                    getString(R.string.addon_successfully_enabled, addon.translateName(this)),
                                    Toast.LENGTH_SHORT
                            ).show()
                        },
                        onError = {
                ...
                this.components.addonManager.disableAddon(
                        ...
                        onSuccess = {
                            ...
                            Toast.makeText(
                                    this,
                                    getString(R.string.addon_successfully_disabled, addon.translateName(this)),
                                    Toast.LENGTH_SHORT
                            ).show()
                        },
                        onError = {
        ...
        findViewById<View>(R.id.remove_add_on).setOnClickListener {
            this.components.addonManager.uninstallAddon(
                    ...
                    onSuccess = {
                        Toast.makeText(
                                this,
                                getString(R.string.addon_successfully_uninstalled, addon.translateName(this)),
                                Toast.LENGTH_SHORT
                        ).show()
                        finish()
                    },
